...
4. RUN mainHyperparameterRandomSearch.py ; in line 13, edit the number of random sets of hyperparameters you want to test. At 100 sets, training can take really wrong (~2.3 hours). Default to 10 sets. Our project tested 100 random sets.
